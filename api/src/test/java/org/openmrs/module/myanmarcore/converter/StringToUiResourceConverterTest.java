...
package org.openmrs.module.myanmarcore.converter;
...
public class StringToUiResourceConverterTest extends BaseModuleContextSensitiveTest {
	...
	@Test
	public void convert() {
		UiResource resource1 = converter.convert("myanmarcore:test/test.res");
		Assert.assertThat(resource1.getProvider(), is("myanmarcore"));
	...
	public void convert_shouldThrowExceptionIfNoColons() {
		converter.convert("myanmarcore/test.res");
	}

	@Test(expected = IllegalArgumentException.class)
	public void convert_shouldThrowExceptionIfMoreThanTwoColons() {
		converter.convert("myanmarcore:test:test.res");
	}
}